<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SetOrderLocationCategory.aspx.cs" Inherits="CitySeva.Admin.SetOrderLocationCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        ...
        $(document).ready(function () {
            $("#btnSubmit").click(function () {
                var seletVal = $("#ddlListType option:selected").val();
        ...
        function SaveOrderData(type) {
            ...
            $.ajax({
                ...
                url: "adminservice.aspx/UpdateOrder",
                data: "{'order':'" + selectVal + "','type':'" + type + "'}",
                dataType: "json",
                async: false,
    ...
    <table class="table table-bordered">
        <tr>
            <td>
                <asp:DropDownList ID="ddlListType" ClientIDMode="Static" CssClass="form-control" OnSelectedIndexChanged="ddlListType_SelectedIndexChanged" AutoPostBack="true" runat="server">

                    <asp:ListItem Text="Select List" Value="0"></asp:ListItem>
        ...
        <tr>
            <td>
                <asp:ListBox ID="lstCatLoc" ClientIDMode="Static" CausesValidation="false" CssClass="form-control listbox" Style="min-height: 340px;" runat="server"></asp:ListBox>
