<%@ Page Title="" Language="C#" MasterPageFile="~/CitySeva.Master" AutoEventWireup="true" CodeBehind="SearchListing.aspx.cs" Inherits="CitySeva.SearchListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Repeater ID="categoryRpt" OnItemDataBound="categoryRpt_ItemDataBound" runat="server" OnItemCommand="categoryRpt_ItemCommand">
        <HeaderTemplate>
        </HeaderTemplate>
        <ItemTemplate>
            <div class="citi_list">
